...
plt.xlabel('Episode')
plt.ylabel('Steps')
plt.title('Steps per Episode - Prioritized_Dueling_DQN')
plt.savefig('plots/steps_Prioritized_Dueling_DQN.png')
plt.close()
...
plt.savefig('plots/q_measures_Prioritized_Dueling_DQN.png')
plt.close()
